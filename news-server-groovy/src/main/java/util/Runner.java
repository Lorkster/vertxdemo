...
public class Runner {
  ...
  private static final String VERTX_DEMO_DIR = "core-examples";
  private static final String VERTX_DEMO_JAVA_DIR = VERTX_DEMO_DIR + "/src/main/java/";
  private static final String VERTX_DEMO_JS_DIR = VERTX_DEMO_DIR + "/src/main/js/";
  private static final String VERTX_DEMO_GROOVY_DIR = VERTX_DEMO_DIR + "/src/main/groovy/";
  private static final String VERTX_DEMO_RUBY_DIR = VERTX_DEMO_DIR + "/src/main/rb/";

  public static void runClusteredExample(Class clazz) {
    runExample(VERTX_DEMO_JAVA_DIR, clazz, new VertxOptions().setClustered(true), null);
  }

  public static void runHaExample(Class clazz) {
    runExample(VERTX_DEMO_JAVA_DIR, clazz, new VertxOptions().setClustered(true).setHAEnabled(true), null);
  }

  public static void runExample(Class clazz) {
    runExample(VERTX_DEMO_JAVA_DIR, clazz, new VertxOptions().setClustered(false), null);
  }

  // JavaScript examples

  public static void runJSExample(String scriptName) {
    runScriptExample(VERTX_DEMO_JS_DIR, scriptName, new VertxOptions().setClustered(false));
  }

  public static void runJSExampleClustered(String scriptName) {
    runScriptExample(VERTX_DEMO_JS_DIR, scriptName, new VertxOptions().setClustered(true));
  }
  ...
  public static void runGroovyExample(String scriptName) {
    runScriptExample(VERTX_DEMO_GROOVY_DIR, scriptName, new VertxOptions().setClustered(false));
  }

  public static void runGroovyExampleClustered(String scriptName) {
    runScriptExample(VERTX_DEMO_GROOVY_DIR, scriptName, new VertxOptions().setClustered(true));
  }
  ...
  public static void runRubyExample(String scriptName) {
    runScriptExample(VERTX_DEMO_RUBY_DIR, scriptName, new VertxOptions().setClustered(false));
  }
